...
class Foro extends React.Component {
    ...
    preview_perfil() {
        ...
        escribir.setAttribute("class", "preview_perfil");
    ...
    render() {
        ...
        return (
            <div class='dashboard' onMouseEnter={this.funcion}>
                ...
                <div id="main">
                    ...
                    <div class='dashboard-app'>
                        <header class='dashboard-toolbar'><a href="#!" class="menu-toggle"></a></header>
                            ...
                            <div class='container'>
                                ...
                                <div class="container">
                                        ...
                                        <div class="col-md-12 text-center ">
                                            <div class="panel panel-default">
                                                <div class="userprofile social ">
                                                    ...
                                                    <h3 class="username">{localStorage.getItem("Creador")}</h3>
                                                    <p>Gujarat, India</p>
                                    ...
                                    <div className='botones'>
                                        ...
                                        <button class="btn btn-primary followbtn" onClick={this.todas_categorias}>Follow</button>
